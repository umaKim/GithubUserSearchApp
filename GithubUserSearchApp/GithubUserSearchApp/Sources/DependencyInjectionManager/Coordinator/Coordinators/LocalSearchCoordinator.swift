...
final public class LocalSearchCoordinator: Coordinator {
    ...
    private(set) var viewController: LocalSearchViewController?
    ...
    public func start() {
        let module = DependencyFactoryImp.buildLocalSearchFeature()
        module
            .transitionPublisher
